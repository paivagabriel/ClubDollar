...
public class TesteActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tvNav = navHeader.findViewById(R.id.tv_nav);
        Font.setKaushanScript(tvNav);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.nav_grade_funcionamento:
                ...
                break;
            case R.id.nav_admin:
                toast("Configurações de Administrador");
                break;
            case R.id.nav_info_app:
                toast("Informações de Desenvolvimento do App.");
                break;
        }
